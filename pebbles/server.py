...
from pebbles.views.oauth_clients import oauth_clients, OAUTHClients
...
api.add_resource(OAUTHClients, api_root + '/oauth_clients')
...
app.register_blueprint(oauth_clients)
